...
function loadImage() {  //图片资源预加载
  let imgs = [
    ...
    "img/Second/2.1backgroud.png",
    "img/Second/2.2.1text.png",
    "img/Second/2.2.2text.png",
    "img/Second/2.2.3text.png",
    "img/Second/2.2.4text.png",
    "img/Second/2.2.5text.png",
    "img/Second/2.2.6text.png",
    "img/Second/2.2.7text.png",
    "img/Second/2.2.8text.png",
    "img/Second/2.2.9text.png",
    "img/Second/2.2.10text.png",
    "img/Second/2.3xing.png",
    "img/Second/2.4xing.png",
    "img/Third.jpg",
  ]
  for (let img of imgs) {
    let image = new Image()
